...
fn getDataRange(funcSelection:u32) -> DataRange {
	...
	if (funcSelection == 0u) { // astroid
		dr.uRange = vec2<f32>(0.0, 2.0 * pi);
		dr.vRange = vec2<f32>(0.0, 2.0 * pi);
		dr.xRange = vec2<f32>(-1.0, 1.0);
		dr.yRange = vec2<f32>(-1.0, 1.0);
		dr.zRange = vec2<f32>(-1.0, 1.0);
	} else if (funcSelection == 1u) { // astroid 2
		dr.uRange = vec2<f32>(0.0, 2.0 * pi);
		dr.vRange = vec2<f32>(0.0, 2.0 * pi);
		dr.xRange = vec2<f32>(-1.0, 1.0);
		dr.yRange = vec2<f32>(-1.0, 1.0);
	...
	else if (funcSelection == 2u) { // astroidal torus
	...
	else if (funcSelection == 3u) { // bohemian dome
		dr.uRange = vec2<f32>(0.0, 2.0*pi);
		dr.vRange = vec2<f32>(0.0, 2.0*pi);
	...
	else if (funcSelection == 4u) { // boy shape
	...
	else if (funcSelection == 5u) { // breather
	...
	else if (funcSelection == 6u) { // enneper
	...
	else if (funcSelection == 7u) { // figure 8
	...
	else if (funcSelection == 8u) { // Henneberg
	...
	else if (funcSelection == 10u) { // klein-bottle
		dr.uRange = vec2<f32>(0.0, pi);
		dr.vRange = vec2<f32>(0.0, 2.0 * pi);
	...
	else if (funcSelection == 23u) { // sinc
		dr.uRange = vec2<f32>(-8.0, 8.0);
		dr.vRange = vec2<f32>(-8.0, 8.0);
		dr.xRange = vec2<f32>(-8.0, 8.0);
		dr.yRange = vec2<f32>(-0.3, 1.0);
		dr.zRange = vec2<f32>(-8.0, 8.0);
	} 
	else if (funcSelection == 24u) { // peaks
		dr.uRange = vec2<f32>(-3.0, 3.0);
		dr.vRange = vec2<f32>(-3.0, 3.0);
		dr.xRange = vec2<f32>(-3, 3);
		dr.yRange = vec2<f32>(-6.8, 8.1);
		dr.zRange = vec2<f32>(-3, 3);
	}
	return dr;
}
...
fn parametricSurfaceFunc(u:f32, v:f32, funcSelection:u32) -> vec3f {
	...
	else if (funcSelection == 1u) { // astroid2
		pos = astroid2(u, v);
	}
	else if (funcSelection == 2u) { // astroidal torus
